...
public class User
{
    ...
    [JsonPropertyName("public_email")] public string PublicEmail { get; set; }
    ...
    [JsonPropertyName("work_information")] public object WorkInformation { get; set; }
    ...
    [JsonPropertyName("last_sign_in_at")] public DateTime LastSignInAt { get; set; }

    [JsonPropertyName("confirmed_at")] public DateTime ConfirmedAt { get; set; }

    [JsonPropertyName("theme_id")] public int? ThemeId { get; set; }

    [JsonPropertyName("last_activity_on")] public string LastActivityOn { get; set; }

    [JsonPropertyName("color_scheme_id")] public int? ColorSchemeId { get; set; }

    [JsonPropertyName("projects_limit")] public int? ProjectsLimit { get; set; }
    ...
    [JsonPropertyName("can_create_group")] public bool? CanCreateGroup { get; set; }
    ...
    [JsonPropertyName("commit_email")] public string CommitEmail { get; set; }
}