...
public class Namespace
{
    ...
    [JsonPropertyName("parent_id")] public object ParentId { get; set; }
    ...
    [JsonPropertyName("max_seats_used")] public int? MaxSeatsUsed { get; set; }

    [JsonPropertyName("seats_in_use")] public int? SeatsInUse { get; set; }

    [JsonPropertyName("plan")] public string Plan { get; set; }

    [JsonPropertyName("trial_ends_on")] public object TrialEndsOn { get; set; }

    [JsonPropertyName("trial")] public bool? Trial { get; set; }
}