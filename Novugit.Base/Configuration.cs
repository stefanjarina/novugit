...
public class Configuration : IConfiguration
{
  ...
  public Configuration(ISecretService secretService, string configPath = null)
  {
    _secretService = secretService;
    _configPath = configPath ?? ConstructDefaultConfigPath();
  ...
  private static string ConstructDefaultConfigPath()
  {
